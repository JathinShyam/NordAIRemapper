...
| 2026-08-23 | [visual-overlay-edge-popup](./2026-08-23-visual-overlay-edge-popup/) | Visual Overlay: Plus Key edge pill + glow; Preview on screen; raised key anchor; state-aware toggle icons |
...
| 2026-08-25 | [onboarding-embedded-unlock](./2026-08-25-onboarding-embedded-unlock/) | Onboarding page 2 hosts the full Unlock UI inline — no subpage detour; dedicated notifications page before Unlock, battery-only Keep-alive |
